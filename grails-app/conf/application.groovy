...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'itu.tpt.pari.Utilisateur'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'itu.tpt.pari.UtilisateurRole'
grails.plugin.springsecurity.authority.className = 'itu.tpt.pari.Role'
